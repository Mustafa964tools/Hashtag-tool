...
import { Loader2, Copy, Check, Hash, Sparkles, Youtube, AlignRight, RefreshCw } from 'lucide-react';
    ...
    <div className="min-h-screen bg-neutral-950 text-white flex flex-col items-center py-12 px-4 md:px-8 font-sans selection:bg-[#E54825]/30 selection:text-white" dir="rtl">
      ...
      <header className="relative w-full max-w-4xl mb-10 flex flex-col items-center text-center z-10 pt-8">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-4 select-none">
          ئامرازی <span className="text-transparent bg-clip-text bg-gradient-to-l from-[#E54825] to-[#f97316]">964</span> بۆ سۆشیاڵ میدیا
        </h1>
        <p className="text-neutral-400 text-lg sm:text-xl font-light max-w-2xl mt-2 leading-relaxed">
          {platform === 'tiktok' 
            ? 'کاپشنی ڤیدیۆکەت لێرە دابنێ و با ژیری دەستکرد باشترین هاشتاگەکانت بۆ بنووسێت بۆ تیکتۆک.'
            : 'زانیاری ڤیدیۆکەت دابنێ بۆ وەرگرتنی باشترین تاگەکان بۆ یوتیوب (تاکو ٥٠٠ پیت).'}
        </p>
      </header>
        ...
        <div className="bg-neutral-900/40 backdrop-blur-sm border border-neutral-800/80 rounded-[32px] p-6 md:p-10 shadow-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="relative group">
                ...
                <textarea
                  ...
                  placeholder={platform === 'tiktok' 
                    ? "نموونە: یاریزانانی هەڵبژاردەی عێراق ئامادەییان نیشاندا بۆ یارییەکە..."
                    : "نموونە: لەم ڤیدیۆیەدا باس لە گەشەی ئابووری دەکرێت لە هەرێمی کوردستان..."}
                  className="w-full h-56 bg-neutral-950/50 text-neutral-100 rounded-2xl p-6 border border-neutral-800 focus:border-[#E54825] focus:ring-2 focus:ring-[#E54825]/20 outline-none transition-all resize-none placeholder-neutral-600 text-lg leading-relaxed shadow-inner"
                />
              </div>
              ...
              >
                ...
                <span className="relative z-10 flex items-center gap-2">
                  {isLoading ? (
                    ...
                    <>
                      {platform === 'tiktok' ? <Hash className="w-6 h-6" /> : <Youtube className="w-6 h-6" />}
            ...
            <div className="flex flex-col space-y-5">
              ...
              <div className="relative w-full h-[284px] bg-neutral-950/80 rounded-2xl border border-neutral-800 shadow-inner overflow-hidden flex flex-col focus-within:border-[#E54825] focus-within:ring-1 focus-within:ring-[#E54825]/20 transition-all">
                {hashtags ? (
                  <textarea
                    value={hashtags}
      ...
      {/* Footer */}
      <footer className="mt-auto pt-16 pb-8 text-neutral-600 text-sm font-light">
        پەرەپێدراوە بۆ دەزگای میدیایی 964
      </footer>
    </div>
  );
}
